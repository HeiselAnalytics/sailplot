...
const german: Record<string, string> = {
  ...
  'About Endless plot': 'Informationen zum Endlos-Plot',
  ...
  'Umpire flags': 'Umpire-Flaggen',
  'Boat identification flag': 'Bootskennflagge',
  'Umpire signal': 'Umpire-Signal',
  'No flag': 'Keine Flagge',
  'Protest flag (Y)': 'Protestflagge (Y)',
  'Red (penalty)': 'Rot (Strafe)',
  'Green and white (no penalty)': 'Grün-Weiß (keine Strafe)',
  Yellow: 'Gelb',
  Blue: 'Blau',
  'Black (DSQ)': 'Schwarz (DSQ)',
  'Stored boat color': 'Gespeicherte Bootsfarbe',
